...
bool test_xor_novena()
{
    static constinit auto chip = 
        generate_xor_chip<SpikingCompute<NovenaFirePolicy>>();
    
    using spiking_1000 = SpikingExecution<1000, StochasticSpikeGenerator, NovenaFirePolicy>;
